...
public class NNPlayer implements Player{
	...
	private NN nn;
	private String name = "standard NN player";
	public NNPlayer(GameLogic gmlc, Console console) {
		this.gmlc = gmlc;
	...
	private void setNN() {
		...
		try {
			...
			File file = new File("resources/AIInfo/NNPlayerinfo.nni");
